...
public abstract class CancelCurrentAndRun<State, Intent : IntentHandler<State, Intent, Dependencies>, Dependencies>(
    ...
    override suspend fun handle(
        ...
        operations.cancelCurrentAndRun(intent::class) {
            dependencies.handle(
                ComponentState(
