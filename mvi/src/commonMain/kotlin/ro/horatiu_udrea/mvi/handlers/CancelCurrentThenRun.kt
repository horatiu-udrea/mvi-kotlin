...
/**
 * Abstract class for handling an intent after cancelling the current operation.
 ...
 */
public abstract class CancelCurrentThenRun<State, Intent : IntentHandler<State, Intent, Dependencies>, Dependencies>(
