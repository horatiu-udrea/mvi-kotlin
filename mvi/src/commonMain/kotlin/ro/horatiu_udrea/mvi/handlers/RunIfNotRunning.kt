...
/**
 * Abstract class for handling an intent if the operation is not already running.
 ...
 */
public abstract class RunIfNotRunning<State, Intent : IntentHandler<State, Intent, Dependencies>, Dependencies>(
